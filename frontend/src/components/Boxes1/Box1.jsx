    ...
    <div className='my-1'>
        <div className='px-1'>
            <div className='flex items-center gap-8'>
                <h1 className='font-[650] text-[2.1rem] text-gray-800'>Our Product Range </h1>
                <div className='flex items-center'>
                    <p className='underline font-[600] text-center text-md text-gray-800'>View All categories</p>
                    <IoIosArrowForward size={15} className='mt-1' />
                </div>
            </div>
            <div className='flex items-center gap-8 leading-none'>
                <h2 className='mt-2 font-semibold text-[1.7rem] text-gray-900'>New Development</h2>
                <div className='flex items-center'>
                    <p className='underline font-[600] text-center mt-2 text-md text-gray-800'>View All </p>
