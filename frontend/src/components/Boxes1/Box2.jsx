...
const Box2 = () => {
    const box = [
        {
            img:"/src/assets/image18.jpeg",
            tag:{ isOpen:true, tagTitle:"Download Now . .", tagColor:"yellow"},
        },
        {
            img:"/src/assets/image19.jpeg",
            text:"Flow Meter",
            tag:{ isOpen:true, tagTitle:"Download Now . .", tagColor:"yellow"},
        },
        {
            img:"/src/assets/image15.jpeg",
    ...
    <div className='my-1'>
        <div className='px-1'>
            <div className='flex items-center gap-8 leading-none'>
                <h2 className='mt-2 font-semibold text-[1.7rem] text-gray-900'>Flow Meter</h2>
